...
INSERT INTO `admin_logs` (`id`, `admin_id`, `action_type`, `action_description`, `target_type`, `target_id`, `old_values`, `new_values`, `ip_address`, `user_agent`, `created_at`) VALUES
...
CREATE TABLE `benefactor_applications` (
  ...
  `documents` text DEFAULT NULL COMMENT 'JSON array of uploaded files',
  `additional_info` text DEFAULT NULL COMMENT 'JSON object with all other data',
  `full_legal_name` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `benefactor_applications`
--
...
INSERT INTO `contacts` (`id`, `user_id`, `name`, `email`, `phone`, `subject`, `message`, `status`, `admin_notes`, `replied_at`, `created_at`) VALUES
(1, 8, 'Nguyễn Văn Trọng', 'tronglen10123456@gmail.com', '0974544545', 'general', 'nhu', 'resolved', NULL, '2026-03-13 19:07:32', '2026-03-13 19:06:49');
...
INSERT INTO `events` (`id`, `user_id`, `title`, `slug`, `description`, `content`, `thumbnail`, `bank_name`, `bank_account`, `bank_owner`, `gallery`, `video_url`, `category`, `location`, `province`, `district`, `ward`, `specific_address`, `target_amount`, `current_amount`, `volunteer_needed`, `volunteer_registered`, `volunteer_skills`, `start_date`, `end_date`, `registration_deadline`, `status`, `rejection_reason`, `priority`, `is_featured`, `is_urgent`, `views`, `has_report`, `report_uploaded_at`, `approved_by`, `approved_at`, `created_at`, `updated_at`, `admin_notes`) VALUES
(1, 2, 'Hỗ trợ phẫu thuật tim cho bé Minh An', 'ho-tro-phau-thuat-tim-be-minh-an', 'Bé Minh An 5 tuổi bị tim bẩm sinh, cần phẫu thuật gấp nhưng gia đình không đủ chi phí', '<h3>Hoàn cảnh</h3><p>Bé Minh An sinh ra đã mắc bệnh tim bẩm sinh. Gia đình nghèo, bố mẹ làm công nhân, không đủ tiền phẫu thuật...</p><h3>Chi phí cần thiết</h3><ul><li>Phẫu thuật: 80 triệu</li><li>Điều trị sau phẫu thuật: 20 triệu</li></ul>', 'event1.jpg', NULL, NULL, NULL, NULL, NULL, 'medical', 'Bệnh viện Tim Hà Nội', 'Hà Nội', 'Đống Đa', NULL, NULL, 100000000.00, 65400000.00, 5, 3, NULL, '2026-02-01', '2026-03-15', NULL, 'approved', NULL, 0, 1, 1, 351, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-03-13 17:03:55', NULL),
(2, 2, 'Xây nhà tình thương cho gia đình chị Hồng', 'xay-nha-tinh-thuong-gia-dinh-chi-hong', 'Chị Hồng nuôi 3 con nhỏ, sống trong căn nhà dột nát cần được xây mới', '<h3>Hoàn cảnh</h3><p>Chị Hồng góa chồng, một mình nuôi 3 con nhỏ. Căn nhà cũ đã xuống cấp nghiêm trọng...</p>', 'event2.jpg', NULL, NULL, NULL, NULL, NULL, 'community', 'Xã Hòa Bình, Huyện Mỹ Đức', 'Hà Nội', 'Mỹ Đức', NULL, NULL, 50000000.00, 32000000.00, 15, 12, NULL, '2026-02-10', '2026-04-30', NULL, 'approved', NULL, 0, 1, 0, 223, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-03-02 04:15:22', NULL),
(3, 3, 'Khám chữa bệnh miễn phí cho người nghèo', 'kham-chua-benh-mien-phi-nguoi-ngheo', 'Chương trình khám bệnh, phát thuốc miễn phí cho 500 người dân nghèo vùng cao', '<h3>Nội dung chương trình</h3><p>Đoàn y tế sẽ lên vùng cao khám bệnh, phát thuốc miễn phí cho bà con...</p>', 'event3.jpg', NULL, NULL, NULL, NULL, NULL, 'medical', 'Huyện Mường Lát', 'Thanh Hóa', 'Mường Lát', NULL, NULL, 30000000.00, 28200000.00, 20, 18, NULL, '2026-02-15', '2026-02-17', NULL, 'approved', NULL, 0, 0, 0, 193, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-26 19:27:32', NULL),
(4, 2, 'Trao học bổng cho học sinh nghèo vượt khó', 'trao-hoc-bong-hoc-sinh-ngheo-vuot-kho', 'Trao 100 suất học bổng cho học sinh có hoàn cảnh khó khăn nhưng học giỏi', '<h3>Mục tiêu</h3><p>Hỗ trợ 100 học sinh nghèo vượt khó với mỗi suất 2 triệu đồng/năm...</p>', 'event4.jpg', NULL, NULL, NULL, NULL, NULL, 'education', 'Trường THCS Lý Tự Trọng', 'Hà Nội', 'Hoàng Mai', NULL, NULL, 200000000.00, 145000000.00, 10, 8, NULL, '2026-02-20', '2026-03-31', NULL, 'approved', NULL, 0, 1, 0, 422, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-03-13 15:33:57', NULL),
(5, 3, 'Xây dựng thư viện cho trường học vùng cao', 'xay-dung-thu-vien-truong-hoc-vung-cao', 'Xây dựng thư viện với 2000 đầu sách cho học sinh vùng cao', '<h3>Dự án</h3><p>Xây phòng thư viện 50m2, trang bị 2000 đầu sách phù hợp...</p>', 'event5.jpg', NULL, NULL, NULL, NULL, NULL, 'education', 'Trường Tiểu học Tà Lèng', 'Lai Châu', 'Mường Tè', NULL, NULL, 80000000.00, 54000000.00, 8, 5, NULL, '2026-02-25', '2026-05-30', NULL, 'approved', NULL, 0, 0, 0, 167, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
(6, 2, 'Cứu trợ đồng bào lũ lụt miền Trung', 'cuu-tro-dong-bao-lu-lut-mien-trung', 'Hỗ trợ lương thực, nhu yếu phẩm cho 1000 hộ dân bị lũ lụt', '<h3>Tình hình</h3><p>Mưa lũ kéo dài khiến hàng nghìn gia đình mất nhà cửa, mất mùa...</p>', 'event6.jpg', NULL, NULL, NULL, NULL, NULL, 'disaster', 'Huyện Hương Khê', 'Hà Tĩnh', 'Hương Khê', NULL, NULL, 150000000.00, 127000000.00, 30, 28, NULL, '2026-01-15', '2026-02-28', NULL, 'approved', NULL, 0, 1, 1, 528, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-28 07:47:57', NULL),
(7, 3, 'Hỗ trợ người dân vùng hạn hán', 'ho-tro-nguoi-dan-vung-han-han', 'Cung cấp nước sạch và lương thực cho vùng hạn hán', '<h3>Tình trạng</h3><p>Hạn hán kéo dài, thiếu nước sinh hoạt trầm trọng...</p>', 'event7.jpg', NULL, NULL, NULL, NULL, NULL, 'disaster', 'Huyện Krông Pắc', 'Đắk Lắk', 'Krông Pắc', NULL, NULL, 100000000.00, 89000000.00, 25, 22, NULL, '2026-02-01', '2026-03-20', NULL, 'approved', NULL, 0, 0, 1, 299, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-03-13 17:09:14', NULL),
(8, 2, 'Tết ấm cho trẻ em mồ côi', 'tet-am-cho-tre-em-mo-coi', 'Tổ chức Tết Trung thu cho 200 trẻ em mồ côi tại trại trẻ', '<h3>Chương trình</h3><p>Tổ chức đêm trung thu với bánh kẹo, quà tặng, văn nghệ...</p>', 'event8.jpg', NULL, NULL, NULL, NULL, NULL, 'children', 'Trại trẻ mồ côi Hà Cầu', 'Hà Nội', 'Hà Đông', NULL, NULL, 40000000.00, 38000000.00, 15, 15, NULL, '2026-02-10', '2026-02-28', NULL, 'approved', NULL, 0, 1, 0, 345, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
(9, 3, 'Khám tim miễn phí cho trẻ em nghèo', 'kham-tim-mien-phi-tre-em-ngheo', 'Khám sàng lọc tim bẩm sinh cho 500 trẻ em vùng nghèo', '<h3>Mục đích</h3><p>Phát hiện sớm các bệnh lý tim bẩm sinh ở trẻ em...</p>', 'event9.jpg', NULL, NULL, NULL, NULL, NULL, 'children', 'Bệnh viện Nhi Trung ương', 'Hà Nội', 'Đống Đa', NULL, NULL, 60000000.00, 42000000.00, 12, 9, NULL, '2026-02-18', '2026-03-10', NULL, 'approved', NULL, 0, 0, 0, 203, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-28 08:08:00', NULL),
(10, 2, 'Tặng quà Tết cho người già neo đơn', 'tang-qua-tet-nguoi-gia-neo-don', 'Tặng 300 phần quà Tết cho người cao tuổi neo đơn', '<h3>Nội dung</h3><p>Mỗi phần quà gồm: gạo, dầu ăn, bánh kẹo, tiền mặt...</p>', 'event10.jpg', NULL, NULL, NULL, NULL, NULL, 'elderly', 'Phường Khương Trung', 'Hà Nội', 'Thanh Xuân', NULL, NULL, 45000000.00, 45000000.00, 10, 10, NULL, '2026-01-20', '2026-02-10', NULL, 'completed', NULL, 0, 0, 0, 178, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
(11, 3, 'Chăm sóc sức khỏe người cao tuổi', 'cham-soc-suc-khoe-nguoi-cao-tuoi', 'Khám bệnh, tặng quà cho 200 cụ già tại viện dưỡng lão', '<h3>Hoạt động</h3><p>Khám bệnh, tư vấn sức khỏe, tặng quà, văn nghệ...</p>', 'event11.jpg', NULL, NULL, NULL, NULL, NULL, 'elderly', 'Viện dưỡng lão Hà Nội', 'Hà Nội', 'Đống Đa', NULL, NULL, 35000000.00, 31000000.00, 8, 7, NULL, '2026-02-22', '2026-03-05', NULL, 'approved', NULL, 0, 0, 0, 145, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
(12, 2, 'Trồng cây xanh - Phủ xanh Việt Nam', 'trong-cay-xanh-phu-xanh-viet-nam', 'Trồng 10,000 cây xanh tại khu vực bị phá rừng', '<h3>Mục tiêu</h3><p>Khôi phục rừng, cải thiện môi trường sống...</p>', 'event12.jpg', NULL, NULL, NULL, NULL, NULL, 'environment', 'Huyện Hoàng Su Phì', 'Hà Giang', 'Hoàng Su Phì', NULL, NULL, 70000000.00, 48000000.00, 50, 42, NULL, '2026-03-01', '2026-04-30', NULL, 'approved', NULL, 0, 1, 0, 267, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
(13, 3, 'Dọn rác biển - Bảo vệ đại dương', 'don-rac-bien-bao-ve-dai-duong', 'Chiến dịch thu gom rác thải nhựa trên bãi biển', '<h3>Kế hoạch</h3><p>Tổ chức 3 đợt dọn rác tại các bãi biển Đà Nẵng...</p>', 'event13.jpg', NULL, NULL, NULL, NULL, NULL, 'environment', 'Bãi biển Mỹ Khê', 'Đà Nẵng', 'Sơn Trà', NULL, NULL, 25000000.00, 23000000.00, 100, 95, NULL, '2026-02-28', '2026-03-15', NULL, 'approved', NULL, 0, 0, 0, 312, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
(14, 2, 'Trao tặng xe lăn cho người khuyết tật', 'trao-tang-xe-lan-nguoi-khuyet-tat', 'Tặng 50 chiếc xe lăn cho người khuyết tật có hoàn cảnh khó khăn', '<h3>Đối tượng</h3><p>Người khuyết tật nghèo, không có phương tiện di chuyển...</p>', 'event14.jpg', NULL, NULL, NULL, NULL, NULL, 'other', 'Trung tâm Phục hồi chức năng', 'TP.HCM', 'Quận 1', NULL, NULL, 120000000.00, 95000000.00, 5, 4, NULL, '2026-02-12', '2026-03-25', NULL, 'approved', NULL, 0, 0, 0, 198, 0, NULL, NULL, NULL, '2026-02-25 15:17:28', '2026-02-25 15:17:28', NULL),
...
(1, 1, 'admin', 'Đơn đăng ký nhà hảo tâm mới', 'Nguyễn Văn Trọng - 23010817 đã nộp đơn đăng ký nhà hảo tâm', 'http://localhost/DACS-CharityManager/admin/benefactors/application_detail.php?id=1', 1, NULL, '2026-03-13 15:03:35'),
(2, 9, 'admin', 'Đơn đăng ký nhà hảo tâm được duyệt', 'Chúc mừng! Đơn đăng ký nhà hảo tâm của bạn đã được phê duyệt. Bạn có thể bắt đầu tạo sự kiện từ thiện ngay bây giờ.', NULL, 0, NULL, '2026-03-13 15:04:03'),
(3, 9, 'admin', 'Đơn đăng ký nhà hảo tâm được duyệt', 'Chúc mừng! Đơn đăng ký nhà hảo tâm của bạn đã được phê duyệt. Bạn có thể bắt đầu tạo sự kiện từ thiện ngay bây giờ.', 'http://localhost/DACS-CharityManager/benefactor/dashboard.php', 0, NULL, '2026-03-13 15:04:03'),
(4, 1, 'admin', 'Sự kiện mới chờ duyệt', 'trong đã tạo sự kiện \"test 13-3-2026\" chờ phê duyệt', 'http://localhost/DACS-CharityManager/admin/events/event_detail.php?id=16', 1, NULL, '2026-03-13 15:07:03'),
(5, 9, 'admin', 'Sự kiện được duyệt', 'Sự kiện \"test 13-3-2026\" của bạn đã được phê duyệt và hiển thị công khai.', 'http://localhost/DACS-CharityManager/benefactor/events/detail.php?id=16', 0, NULL, '2026-03-13 15:07:58'),
(6, 1, 'admin', 'Sự kiện mới chờ duyệt', 'trong đã tạo sự kiện \"test\" chờ phê duyệt', 'http://localhost/DACS-CharityManager/admin/events/event_detail.php?id=19', 1, NULL, '2026-03-13 15:22:48'),
(7, 1, 'admin', 'Sự kiện mới chờ duyệt', 'trong đã tạo sự kiện \"test\" chờ phê duyệt', 'http://localhost/DACS-CharityManager/admin/events/event_detail.php?id=20', 1, NULL, '2026-03-13 15:24:09'),
(8, 9, 'admin', 'Sự kiện chưa được duyệt', 'Sự kiện \"test\" chưa được phê duyệt. Lý do: Mục tiêu quyên góp chưa hợp lý', 'http://localhost/DACS-CharityManager/benefactor/events/edit.php?id=20', 0, NULL, '2026-03-13 15:32:09'),
(9, 1, 'admin', 'Sự kiện mới chờ duyệt', 'trong đã tạo sự kiện \"test\" chờ phê duyệt', 'http://localhost/DACS-CharityManager/admin/events/event_detail.php?id=21', 1, NULL, '2026-03-13 15:32:51'),
(10, 9, 'admin', 'Sự kiện được duyệt', 'Sự kiện \"test\" của bạn đã được phê duyệt và hiển thị công khai.', 'http://localhost/DACS-CharityManager/benefactor/events/detail.php?id=21', 0, NULL, '2026-03-13 15:33:18'),
...
--
ALTER TABLE `event_expenses`
  ADD CONSTRAINT `event_expenses_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE;
